public class CustomerRecord {
    ...
    public void setCustomerID(String customerID) { this.customerID = padOrTruncate(customerID, 5); }
    
    public String getLastName() { return lastName; }
    public void setLastName(String lastName) { this.lastName = padOrTruncate(lastName, 50); }
    
    public String getFirstName() { return firstName; }
    public void setFirstName(String firstName) { this.firstName = padOrTruncate(firstName, 50); }
    
    public String getContractID() { return contractID; }
    public void setContractID(String contractID) { this.contractID = padOrTruncate(contractID, 5); }
    
    public String getComment() { return comment; }
    public void setComment(String comment) { this.comment = padOrTruncate(comment, 25); }
    ...
    public static CustomerRecord fromFixedWidthString(String line) {
        if (line == null || line.length() < 135) {
            throw new IllegalArgumentException("Invalid record length. Expected 135 characters.");
        }
