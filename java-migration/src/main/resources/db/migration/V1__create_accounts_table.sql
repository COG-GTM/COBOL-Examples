...
--
-- Original COBOL application used PostgreSQL via ODBC with esqlOC precompiler.
-- This migration creates the same schema used by the COBOL sql_example program.
...
-- Populate fake account data (same test data from create_test_db.sql)
