-- Database schema migration for the COBOL-to-Java migration.
-- Reference: sql/create_test_db.sql from the COBOL project.
...
-- Populate fake account data (same as the COBOL create_test_db.sql).
