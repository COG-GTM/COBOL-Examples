-- Flyway migration based on sql/create_test_db.sql from the COBOL project.
-- The original script creates the database and populates it; this migration
-- handles only the schema creation within the existing database.
...
-- Populate fake account data matching the original COBOL test data.
